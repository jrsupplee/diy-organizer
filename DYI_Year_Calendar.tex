...
% - weekday
\newcolumntype{W}{>{\hspace*{\fill}\normalfont\footnotesize}p{\WkdayColWidthMonthTblYC}<{\hspace*{\fill}}@{\extracolsep\fill}}
% - Saturday
\newcolumntype{S}{>{\hspace*{\fill}\normalfont\footnotesize\color{WeekendDay}}p{\WkdayColWidthMonthTblYC}<{\hspace*{\fill}}@{\extracolsep\fill}}
% - Sunday
\newcolumntype{Z}{>{\hspace*{\fill}\normalfont\footnotesize\color{WeekendDay}}p{\WkdayColWidthMonthTblYC}<{\hspace*{\fill}}}

\newcommand{\MonthTblYC}[1]{%
	\begin{tabular*}{\MonthTblWidthYC}[t]{@{}Z*{5}{W}S@{}}
		\rowcolor{HeadSubBg}

...
\definecolor{HeadMainBg}{gray}{0.3}
...
\newcommand{\WkdayTblRow}[1]{%
	#1{\Sun} & #1{\Mon} & #1{\Tue} & #1{\Wed} & #1{\Thu} & #1{\Fri} & #1{\Sat}}
% - as above but condensed to just one letter
\newcommand{\WkdayTblRowA}[1]{%
	#1{\SunA} & #1{\MonA} & #1{\TueA} & #1{\WedA} & #1{\ThuA} & #1{\FriA} & #1{\SatA}}
